...
execute_process(
  COMMAND "C:/Program Files/Git/cmd/git.exe" --git-dir=.git show-ref "5c0679bca78a4caa38809461622f2dde712470e6"
  WORKING_DIRECTORY "C:/Users/ALICE/Desktop/IMAC/Travail/Programmation et Algorithmie/renduS2/Digger/build/_deps/exe_path-src"
...
if(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/remotes/")
  ...
  set(checkout_name "5c0679bca78a4caa38809461622f2dde712470e6")
...
elseif(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/tags/")
  ...
  get_hash_for_ref("5c0679bca78a4caa38809461622f2dde712470e6" tag_sha error_msg)
  if(tag_sha STREQUAL head_sha)
    message(VERBOSE "Already at requested tag: 5c0679bca78a4caa38809461622f2dde712470e6")
    return()
  endif()
...
elseif(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/heads/")
  ...
  set(checkout_name "origin/5c0679bca78a4caa38809461622f2dde712470e6")
  ...
  elseif(tag_sha STREQUAL "")
    ...
    if(NOT can_fetch)
      message(FATAL_ERROR
        "Requested git ref \"5c0679bca78a4caa38809461622f2dde712470e6\" is not present locally, and not "
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: 'C:/Users/ALICE/Desktop/IMAC/Travail/Programmation et Algorithmie/renduS2/Digger/build/_deps/exe_path-src'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: 'C:/Users/ALICE/Desktop/IMAC/Travail/Programmation et Algorithmie/renduS2/Digger/build/_deps/exe_path-src'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
